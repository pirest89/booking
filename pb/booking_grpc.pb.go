...
type BookingServiceClient interface {
	...
	ViewBooking(ctx context.Context, in *ViewBookingRequest, opts ...grpc.CallOption) (*Booking, error)
...
func (c *bookingServiceClient) CreateBooking(ctx context.Context, in *BookingRequest, opts ...grpc.CallOption) (*Booking, error) {
	out := new(Booking)
	err := c.cc.Invoke(ctx, "/training.BookingService/CreateBooking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) ViewBooking(ctx context.Context, in *ViewBookingRequest, opts ...grpc.CallOption) (*Booking, error) {
	out := new(Booking)
	err := c.cc.Invoke(ctx, "/training.BookingService/ViewBooking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) CancelBooking(ctx context.Context, in *CancelBookingRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/training.BookingService/CancelBooking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	...
	ViewBooking(context.Context, *ViewBookingRequest) (*Booking, error)
...
func (UnimplementedBookingServiceServer) ViewBooking(context.Context, *ViewBookingRequest) (*Booking, error) {
...
func _BookingService_CreateBooking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/training.BookingService/CreateBooking",
	}
...
func _BookingService_ViewBooking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/training.BookingService/ViewBooking",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookingService_CancelBooking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/training.BookingService/CancelBooking",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "training.BookingService",
